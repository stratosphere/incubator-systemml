...
public class DataSetAggregateUtils {
	 ...
	 *
	 */
	private static class ExtractMatrixBlock implements MapFunction<Tuple2<MatrixIndexes, CorrMatrixBlock>, Tuple2<MatrixIndexes, MatrixBlock>>
	{
		@Override
	 ...
	 *
	 */
	private static class CreateBlockCombinerFunction implements MapFunction<Tuple2<MatrixIndexes,MatrixBlock>, Tuple2<MatrixIndexes,CorrMatrixBlock>>
	{
		@Override
	...
	public static class MergeSumBlock extends
		...
		@Override
		public void combine(Iterable<Tuple2<MatrixIndexes, CorrMatrixBlock>> values, Collector<Tuple2<MatrixIndexes, CorrMatrixBlock>> out) throws Exception {
