...
public abstract class FLInstruction extends Instruction {
    ...
    public enum FLINSTRUCTION_TYPE {
        TSMM, Reorg, Reblock, CSVReblock, Write, ArithmeticBinary, AggregateUnary, INVALID, MAPMM, MAPMMCHAIN, CPMM, ZIPMM, //RMM, PMM, ZIPMM, PMAPMM, //matrix multiplication instructions
